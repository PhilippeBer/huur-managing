/**
 * @param {GoogleAppsScript.UI.Sidebar} sidebar
 * @return {GoogleAppsScript.UI.Sidebar}
 */
function onOpen() {
  var ui = SpreadsheetApp.getUi();
  ui.createMenu('Rent Manager BE')
...
function showSidebar() {
  var ui = SpreadsheetApp.getUi();
  ui.showSidebar(HtmlService.createHtmlOutputFromFile('UI_Sidebar')
      .setWidth(600));
}
